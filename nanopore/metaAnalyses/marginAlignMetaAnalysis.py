...
class MarginAlignMetaAnalysis(AbstractMetaAnalysis):
    def run(self):
        ...
        for readType, mapper in product(readTypes, self.mappers):
            ...
            outf.close()
            system("Rscript nanopore/metaAnalyses/ROC_marginAlign.R {} {} {}".format(os.path.join(self.outputDir, readType + "_" + mapper + ".tsv"), os.path.join(self.outputDir, readType + "_" + mapper.__name__ + "_ROC_curves.pdf"), len(variantCallingAlgorithms)))
