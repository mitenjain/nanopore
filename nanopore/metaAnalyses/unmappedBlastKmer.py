    ...
    def run(self, kmer_size=5):
        for readType in self.readTypes:
            ...
            if len(unmapped) > 1:
                ...
                system("nanopore/analyses/kmer.pl {} {} {}".format(os.path.join(self.outputDir, readType + "_no_hits.fasta"), os.path.join(self.getLocalTempDir(), readType + "_unmapped_" + str(kmer_size) + "mer"), str(kmer_size)))
                system("nanopore/analyses/kmer.pl {} {} {}".format(os.path.join(self.outputDir, readType + "_mapped_reads.fasta"), os.path.join(self.getLocalTempDir(), readType + "_mapped_" + str(kmer_size) + "mer"), str(kmer_size)))
                ...
                outf.close()
                system("Rscript nanopore/metaAnalyses/barplot_blast.R {} {} {}".format(os.path.join(self.outputDir, readType + "_tmp"), os.path.join(self.outputDir, readType + "_blast_counts.pdf"), readType))
