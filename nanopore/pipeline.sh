...
export PATH=:./submodules/sonLib/bin:./submodules/cactus/bin:./submodules/jobTree/bin:./submodules/bwa/:./submodules/lastz/src/:./submodules/last/src/:./submodules/last/scripts/:./submodules/samtools-0.1.19:./submodules/samtools-0.1.19/bcftools:./submodules/consensus/:${PATH}
